...
const CLASS_2_INFOGRAPHICS: Infographic[] = [
  ...
  { src: "/infografias/clase-2/10_universal verdadero y apariencia", title: "Lo universal verdadero y su apariencia", caption: "El bien general debe ser efectivo y no encubrir privilegios de un sector como si fueran interés común.", question: "¿Qué criterio permite distinguir un universal concreto de una universalidad aparente?" },
];
